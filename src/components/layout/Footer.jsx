...
import { Mail, BookOpen, Terminal, Send } from "lucide-react";
...
export default function Footer() {
  ...
  return (
    <footer className="relative mt-2 border-t border-slate-800/80 bg-[#020817] text-slate-400 selection:bg-violet-500/30">
      ...
      <div className="max-w-7xl mx-auto px-6 py-6 relative z-10">
        ...
        <div className="mt-6 border-t border-slate-800/60 pt-2 flex flex-col md:flex-row items-center justify-between gap-6">
